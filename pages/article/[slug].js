...
const Article = ({ articlemain, categories, submenuones, submenutwos }) => {
  ...
  return (
    <>
      <Head>
        <title>{articlemain?.attributes.Title} | ВЗК</title>
        <meta property="og:title" content={articlemain?.attributes.Title} />
        <meta property="og:site_name" content={articlemain?.attributes.Title} />
        <meta property="og:url" content={'https://vzk.ru/article/' + articlemain?.attributes.slug} />
        <meta property="og:description" content={articlemain?.attributes.Description} />
        <meta property="og:image" content={`${process.env.NEXT_PUBLIC_STRAPI_API_URL}` + articlemain?.attributes.Pic.data.attributes.url} />
      </Head>
