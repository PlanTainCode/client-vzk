...
const IbdCommunity = ({ submenuones, submenutwos, searches }) => {
  return (
    <>
      <Head>
        <title>Поиск сообществ | ВЗК</title>
        <meta property="og:title" content="Поиск сообществ" />
        <meta property="og:site_name" content="Поиск сообществ" />
        <meta property="og:description" content="Поиск сообществ ВЗК" />
      </Head>
