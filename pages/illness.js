...
const Illness = ({ submenuones, submenutwos, illness }) => {
    ...
    return (
        <>
          <Head>
            <title>{illness.attributes.Title} | ВЗК</title>
            <meta property="og:title" content={illness.attributes.Title} />
            <meta property="og:site_name" content={illness.attributes.Title} />
            <meta property="og:description" content={illness.attributes.Description} />
          </Head>
